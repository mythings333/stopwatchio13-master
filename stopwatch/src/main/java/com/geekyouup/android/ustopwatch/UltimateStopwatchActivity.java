...
public class UltimateStopwatchActivity extends SherlockFragmentActivity {
    ...
    // this broadcast receiver receives messages from the GCM service
    private BroadcastReceiver gcmReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            if(mTabsAdapter != null) {
                if(mStopwatchFragment != null && mStopwatchFragment.isAdded()) {
                    StopwatchStateEndpointHelper.getInstance().getStateFromEndpoint(UltimateStopwatchActivity.this, mStopwatchFragment);
                }
            }
        }
    };
	...
	protected void onResume() {
        ...
        if (gcmReceiver != null) {
            IntentFilter intentFilter = new IntentFilter(GCMIntentService.INTENT_EXTRA_WATCH_UPDATE);
